...
::: tip 提示
有阅读障碍的同学，可以跳过第一至四节，下载我写好的[工具包](https://gitee.com/keington/VuePress-Vdoing-Blog.git): 
`git clone https://gitee.com/keington/VuePress-Blog.git` 然后从第五节开始看。
:::
...
3. 我的 [Vuepress-Vdoing-Blog](https://gitee.com/keington/VuePress-Vdoing-Blog.git) 已经开源放在了 Gitee 上，还有很多想要增加的功能，例如添加评论模块、自动生成侧边栏目录、增加网站分析工具等等，在这里欢迎大家 Star 或者 Fork 。
